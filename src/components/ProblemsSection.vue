    ...
    <div class="section__container">
      <div class="section__header section__header--center">
        ...
        <p class="approach-text">
          پاره ای از مشکلات همیشه وجود داشته است که همه می شناسیم اما اکنون برای
          ما روشن است که هر سند یک مسیر دارد و این مسیر باید شفاف و قابل‌پیگیری
          باشد.
        </p>
      </div>
      ...
      <div class="problem-grid">
        <div
          ...
          :key="index"
        >
          <div class="problem-card__icon" v-html="problem.icon"></div>
          <h3 class="problem-card__title">{{ problem.title }}</h3>
          <p class="problem-card__text">{{ problem.text }}</p>
        </div>
      </div>
    </div>
  </section>
